...
#SBATCH --job-name=transformers_training_apd
#SBATCH -o transformers_training_apd.out               
#SBATCH -e transformers_training_apd.err

echo "Running transformers training job on APD"

project_title="transformers_training_apd"
