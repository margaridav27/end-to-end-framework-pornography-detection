...
python -m src.model_training \
       --data_loc "$data_loc" \
       --save_loc "$save_loc" \
       --metrics_save_loc "$state_dict_loc/vgg16_bn_freeze_False_epochs_50_batch_16_optim_sgd_aug_True_split_10_20.pth"

echo "Testing VGG19_BN"
python -m src.model_training \
       --data_loc "$data_loc" \
       --save_loc "$save_loc" \
       --metrics_save_loc "$state_dict_loc/vgg19_bn_freeze_False_epochs_50_batch_16_optim_sgd_aug_True_split_10_20.pth"
