...
#SBATCH --job-name=transformers_training_even_20_2k_1
#SBATCH -o transformers_training_even_20_2k_1.out               
#SBATCH -e transformers_training_even_20_2k_1.err
...
echo "Training beit_base_patch16_224"
python -m src.transformers \
       --project_title "$project_title" \
       --data_loc "$data_loc" \
       --model_save_loc "$model_save_loc" \
