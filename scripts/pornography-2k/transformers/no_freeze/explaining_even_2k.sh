...
#SBATCH --job-name=transformer_explainability
#SBATCH -o transformer_explainability.out               
#SBATCH -e transformer_explainability.err
...
save_loc="results/pornography-2k/transformers/no-freeze/even-20/explanations" 
