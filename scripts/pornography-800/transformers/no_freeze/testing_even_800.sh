...
results_loc="results/pornography-2k/transformers/no-freeze/even-20"
...
python -m src.transformer_testing \
       ...
       --state_dict_loc "$results_loc/models/vit_base_patch16_224_epochs_50_batch_8_optim_sgd_aug_False_split_10_20.pth"
...
python -m src.transformer_testing \
       ...
       --state_dict_loc "$results_loc/models/vit_large_patch16_224_epochs_50_batch_8_optim_sgd_aug_False_split_10_20.pth" \
...
python -m src.transformer_testing \
       ...
       --state_dict_loc "$results_loc/models/deit_base_patch16_224_epochs_50_batch_8_optim_sgd_aug_False_split_10_20.pth"
