...
#SBATCH --job-name=transformers_training_even_20_800
#SBATCH -o transformers_training_even_20_800.out               
#SBATCH -e transformers_training_even_20_800.err


project_title="transformers_training_even_20_800"
...
echo "Running transformers training job on Pornography-800 (even-20)"
