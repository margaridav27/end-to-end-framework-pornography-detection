...
#SBATCH --job-name=training_even_20_800
#SBATCH -o training_even_20_800.out               
#SBATCH -e training_even_20_800.err 

echo "Running training job on Pornography-800 (even-20)"

echo "Training ResNet50"
python -m src.model_training \
       --data_loc "/nas-ctm01/datasets/public/BIOMETRICS/pornography-database/data-processed/even-20" \
       --model_save_loc "results/even-20/no-freeze/pornography-800/models" \
       --metrics_save_loc "results/even-20/no-freeze/pornography-800/metrics" \
       --model_name "resnet50" \
       --epochs 50
